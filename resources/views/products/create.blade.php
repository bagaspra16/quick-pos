            ...
            <div>
                ...
                <div class="flex items-center space-x-4">
                    <label class="inline-flex items-center">
                        <input type="radio" name="available" value="1" {{ old('available', 1) == 1 ? 'checked' : '' }} class="bg-gray-700 border-gray-600">
                        <span class="ml-2">Tersedia</span>
                    </label>
                    <label class="inline-flex items-center">
                        <input type="radio" name="available" value="0" {{ old('available') === '0' ? 'checked' : '' }} class="bg-gray-700 border-gray-600">
