        ...
        <div class="p-6">
            <form action="{{ route('permissions.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-xs text-gray-500 mt-1">Used for checking permissions. If left empty, it will be generated from the name.</p>
                    @error('slug')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea id="description" name="description" rows="2" 
                        class="form-textarea w-full rounded-md shadow-sm border-gray-300 @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div id="menuOptions" class="mb-4 p-4 border border-gray-200 rounded-md {{ old('is_menu') ? '' : 'hidden' }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="text" id="menu_group" name="menu_group" value="{{ old('menu_group') }}" 
